...
import com.rakaliaksei.littlelemon.Home
...
@Composable
fun Onboarding(navController: NavController? = null, sharedPref: SharedPreferences? = null) {
    ...
    val registerCallback: () -> Unit = {
        if (firstName.isNotBlank() && lastName.isNotBlank() && email.isNotBlank() && sharedPref != null) {
            Toast.makeText(
                context,
